...
public class ItemDetailResponse {
    ...
    /**
     * data : [{"item_menu_id":60,"item_avg_time":"","item_code":"Hakka001","item_defaultprice":"120.00","item_created":"2018-08-31 16:54:12","item_most_featured":"0","addon":[{"itemportion_item_id":4,"itemportion_defoult_portion_status":"1","itemportion_price":"58.00","itemportion_portion_id":"9","itemportion_id":265,"itemportion_status":"1"},{"itemportion_item_id":4,"itemportion_defoult_portion_status":"0","itemportion_price":"3.00","itemportion_portion_id":"7","itemportion_id":266,"itemportion_status":"1"}],"item_type":"0","item_available_afternoon_to":"00:00:00","item_available_morning_to":"11:59:59","item_category_id":26,"item_country_id":"SAU","item_available_evening_from":"12:00:00","item_brand_id":50,"item_company_id":30,"item_id":4,"item_name":"Hakka Noodles","item_visiblity":"3","item_most_selling":"0","item_available_afternoon_from":"00:00:00","item_status":1,"item_available_morning_from":"00:00:00","item_available_evening_to":"23:59:59","item_prepration_cost":"30.00","item_image":"1535714652_1522045767_hqdefault.jpg","item_branchprice":"0","item_description":"dsfjhklfsdhffuewrewoi","item_calories":"","item_updated":"2018-08-31 16:54:12"},{"item_menu_id":60,"item_avg_time":"","item_code":"tofu001","item_defaultprice":"120.00","item_created":"2018-09-01 14:47:16","item_most_featured":"0","addon":[{"itemportion_item_id":14,"itemportion_defoult_portion_status":"","itemportion_price":"50.00","itemportion_portion_id":"7","itemportion_id":283,"itemportion_status":"1"}],"item_type":"0","item_available_afternoon_to":"00:00:00","item_available_morning_to":"11:59:59","item_category_id":27,"item_country_id":"SAU","item_available_evening_from":"12:00:00","item_brand_id":16,"item_company_id":2,"item_id":14,"item_name":"Paneer Tofu","item_visiblity":"3","item_most_selling":"0","item_available_afternoon_from":"00:00:00","item_status":1,"item_available_morning_from":"00:00:00","item_available_evening_to":"23:59:59","item_prepration_cost":"50.00","item_image":"1535793436_1522045767_hqdefault.jpg","item_branchprice":"0","item_description":"dfsdfsfsd fsfds ","item_calories":"","item_updated":"2018-09-01 14:47:16"}]
     * message : Success
     * status : 1
     */
    ...
    public class DataEntity {
         ...
         * addon : [{"itemportion_item_id":4,"itemportion_defoult_portion_status":"1","itemportion_price":"58.00","itemportion_portion_id":"9","itemportion_id":265,"itemportion_status":"1"},{"itemportion_item_id":4,"itemportion_defoult_portion_status":"0","itemportion_price":"3.00","itemportion_portion_id":"7","itemportion_id":266,"itemportion_status":"1"}]
         * item_type : 0
        ...
        private List<AddonEntity> addon;
        ...
        public void setAddon(List<AddonEntity> addon) {
            this.addon = addon;
        }
        ...
        public List<AddonEntity> getAddon() {
            return addon;
        }
        ...
        public class AddonEntity {
            /**
             * itemportion_item_id : 4
             * itemportion_defoult_portion_status : 1
             * itemportion_price : 58.00
             * itemportion_portion_id : 9
             * itemportion_id : 265
             * itemportion_status : 1
             */
            private int itemportion_item_id;
            private String itemportion_defoult_portion_status;
            private String itemportion_price;
            private String itemportion_portion_id;
            private int itemportion_id;
            private String itemportion_status;

            public void setItemportion_item_id(int itemportion_item_id) {
                this.itemportion_item_id = itemportion_item_id;
            }

            public void setItemportion_defoult_portion_status(String itemportion_defoult_portion_status) {
                this.itemportion_defoult_portion_status = itemportion_defoult_portion_status;
            }

            public void setItemportion_price(String itemportion_price) {
                this.itemportion_price = itemportion_price;
            }

            public void setItemportion_portion_id(String itemportion_portion_id) {
                this.itemportion_portion_id = itemportion_portion_id;
            }

            public void setItemportion_id(int itemportion_id) {
                this.itemportion_id = itemportion_id;
            }

            public void setItemportion_status(String itemportion_status) {
                this.itemportion_status = itemportion_status;
            }

            public int getItemportion_item_id() {
                return itemportion_item_id;
            }

            public String getItemportion_defoult_portion_status() {
                return itemportion_defoult_portion_status;
            }

            public String getItemportion_price() {
                return itemportion_price;
            }

            public String getItemportion_portion_id() {
                return itemportion_portion_id;
            }

            public int getItemportion_id() {
                return itemportion_id;
            }

            public String getItemportion_status() {
                return itemportion_status;
            }
        }
    }
}
